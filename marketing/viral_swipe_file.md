# Signal Viral Swipe File

Status: active research input for short-form generation.
...
- 0.0-1.5s: artifact and problem visible immediately.
- 1.5-7s: show the weak line or search miss.
- 7-16s: explain score receipt with 2-3 factors.
- 16-25s: rewrite one bullet.
- 25-31s: score payoff and CTA.
...
- Optional: text-message panic, courtroom evidence board, desk audit.

## Caption Style

- Large, mobile-safe, 3-7 words visible at a time.
- Captions should carry the joke or score logic, not transcribe every long sentence.
- Avoid bottom UI collision; keep key proof and CTA above bottom rail.
...
- Job hunters are frustrated and recognize the pain immediately.
- Resume/JD artifacts create proof and specificity.
- One mistake feels actionable; three mistakes feels like homework.
- Score movement becomes believable only when the viewer sees the missing terms/metric/outcome first.
