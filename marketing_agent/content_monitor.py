...
CODEX_APPROVAL_PATH = ROOT / "marketing_agent" / "codex_video_approval.py"
...
def build_report() -> dict:
    ...
    has_codex_approval_gate = CODEX_APPROVAL_PATH.exists()
    ...
    return {
        ...
        "creativeReadiness": {
            ...
            "hasCodexApprovalGate": has_codex_approval_gate,
        ...
        "monetizationReadiness": {
            ...
            "missing": [
                ...
                for item, ok in [
                    ...
                    ("Codex approval gate", has_codex_approval_gate),
...
def write_markdown(report: dict, path: Path) -> None:
    ...
    lines.extend([
        ...
        f"- Codex approval gate available: {readiness['hasCodexApprovalGate']}",
        "",
        "Missing:",
    ])
    ...
    lines.extend([
        ...
        f"- Codex approval gate: {creative['hasCodexApprovalGate']}",
