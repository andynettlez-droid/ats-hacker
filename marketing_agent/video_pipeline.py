...
RESUME_CRIME_SCENE_PROPS = {
    ...
    "subhook": "The proof is real, but the bullet makes me guess.",
    "resumeTitle": "Data Analyst Resume",
    "jobTitle": "Product Data Analyst",
    "jobKeywords": ["SQL", "Tableau", "cohort analysis", "churn dashboard"],
    "weakBullets": [
    ...
    "voiceover_text": "Okay, this line says created reports for business teams and leadership. I would circle it because the job wants SQL, Tableau, and cohort analysis. Lower on the page, the proof says SQL churn dashboard, six hours saved, and 18 at-risk accounts flagged. Now the rewrite has the tool, metric, and outcome. Run the free Signal score before you apply.",
    "musicSrc": "audio/signal-studio-bed.mp3",
    "musicVolume": 0.16,
    "voiceoverSrc": "audio/signal-studio-voiceover.mp3",
