...
- Make one useful teaching point before the CTA.
- End with the free Signal score, not an aggressive paid pitch.

## Current Pilot Batch

Packet: `marketing/daily_content/2026-06-29-ai-looking-resume-bullets-recruiters-ignore`

Pilots:

- `Corporate weather report resume`: AI Resume Roast / comic.
- `Would your resume appear in search?`: Recruiter Search Test / sticky note.
- `Resume Crime Scene: Hidden Proof`: Resume Crime Scene / highlighter, with Signal acting as the evidence-finding character.

Rendered review pilot:

- `marketing/remotion/out/daily-resume-crime-scene-hidden-proof-pilot.mp4`
