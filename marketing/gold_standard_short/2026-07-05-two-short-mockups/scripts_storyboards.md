# Two Signal Short Mockups

Status: review_required. Do not publish without explicit Codex chat approval.

## Short 1: Resume Teardown And Fix

File: `01-resume-teardown-shawn-google-network.mp4`

Format: Vertical 9:16, recruiter-style teardown.
...
Use natural desk-review motion: paper tilt, marker strike, score receipt pop, green rewrite slide-in. Signal appears as a small guide, not the main subject. The artifact is the resume.

## Short 2: Signal Breaks Through Filters

File: `02-signal-filter-breakthrough.mp4`

Format: Vertical 9:16, animated brand-action short.
...
This is the more professional interpretation of the reference image: same journey, but rebuilt as motion. It should eventually evolve into a fully rigged Signal character animation with stronger screen depth, better particle passes, and a clearer hiring-manager read moment.
