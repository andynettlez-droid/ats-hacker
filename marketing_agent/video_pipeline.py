...
def run_remotion_render(props, composition="AvatarReveal", run_dir=None):
    ...
    out_name = "signal_reveal.mp4" if composition == "SignalReveal" else "autonomous_reveal.mp4"
    dest_name = "signal-reveal.mp4" if composition == "SignalReveal" else "autonomous-ad.mp4"
...
def main():
    ...
    if args.viral and args.signal:
        parser.error("--viral and --signal target different templates; choose one.")
    ...
    composition = "SignalReveal" if args.signal else "AvatarReveal"
    dest_name = "signal-reveal.mp4" if args.signal else "autonomous-ad.mp4"
    out_name = "signal_reveal.mp4" if args.signal else "autonomous_reveal.mp4"
